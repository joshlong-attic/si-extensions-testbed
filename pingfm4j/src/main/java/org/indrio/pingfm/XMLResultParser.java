        ...
        if (servicesElement != null) {
            ...
            if (elements != null && !elements.isEmpty()) {
                ...
                for (Element serviceElements : elements) {
                    Service service = new Service(serviceElements.getAttributeValue("id"), serviceElements.getAttributeValue("name"));
                    service.setTrigger(new Trigger(serviceElements.getChildTextTrim("trigger"), null));
        ...
        if (triggersElement != null) {
            ...
            if (elements != null && !elements.isEmpty()) {
                ...
                for (Element triggerElements : elements) {
                    Trigger trigger = new Trigger(triggerElements.getAttributeValue("id"), triggerElements.getAttributeValue("method"));
                    List<Element> serviceElements = triggerElements.getChildren("service");
                    for (Element serviceElement : serviceElements) {
                        trigger.addService(new Service(serviceElement.getAttributeValue("id"), serviceElement.getAttributeValue("name")));
                    }
        ...
        if (messagesElement != null) {
            ...
            if (elements != null && !elements.isEmpty()) {
                ...
                for (Element messageElements : elements) {
                    ...
                    Message message = new Message(messageElements.getAttributeValue("id"), messageElements.getAttributeValue("method"));
                    ...
                    if (contentElement != null) {
                        ...
                        message.setContentTitle((title != null ? new String(Base64.decodeBase64(title.getBytes())) : null));
                        message.setContentBody((body != null ? new String(Base64.decodeBase64(body.getBytes())) : null));
                    }
