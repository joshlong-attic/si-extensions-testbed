 ...
 * <p/>
 * TODO this should be a drop-in replacement for the polling version TODO this should throw a unholy fit if we detect
 * that java.library.path isn't set since this (clearly) won't work without it.
 */
