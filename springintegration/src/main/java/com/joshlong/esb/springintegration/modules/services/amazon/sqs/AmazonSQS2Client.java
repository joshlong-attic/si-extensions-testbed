...
public class AmazonSQS2Client
    ...
    volatile private ConcurrentLinkedQueue<Message> messagesNotYetRecieved;
    volatile private String awsUser, awsPassword, awsHost;
    volatile private QueueService queueService;
    volatile private ConcurrentHashMap<String, MessageQueue> messageQueuesById;
    ...
    public boolean equals(final Object o) {
        if (o instanceof AmazonSQS2Client) {
            ...
            return eqb.append(
                    other.getAwsHost(), this.getAwsHost()).append(
                    other.getAwsPassword(), this.getAwsPassword()).append(
    ...
    private String send(QueueService queueService, String queueId, String msgPayload) throws Exception {
    ...
    public Message receive(String queueId, boolean shouldDeleteOnReceipt) throws Exception {
        return this.receive(this.queueService, queueId, shouldDeleteOnReceipt);
    }

    private Message receive(QueueService queueService,
                            String queueuId,
                            boolean shouldDeleteOnReceipt) throws Exception {
